 ...
 * {@link com.jd.jtf.common.inject.PrivateModule PrivateModule} for details.
 * 
...
public interface PrivateBinder extends Binder {
   ...
   * com.jd.jtf.common.inject.binder.AnnotatedElementBuilder#annotatedWith(Class) annotatedWith()} to expose {@code type} with a
   * binding annotation.
   */
