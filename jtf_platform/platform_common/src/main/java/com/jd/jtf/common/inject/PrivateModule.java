...
package com.jd.jtf.common.inject;
...
import com.jd.jtf.common.inject.binder.LinkedBindingBuilder;
import com.jd.jtf.common.inject.matcher.Matcher;
import com.jd.jtf.common.inject.spi.Message;
import com.jd.jtf.common.inject.spi.ProvisionListener;
import com.jd.jtf.common.inject.spi.TypeConverter;
import com.jd.jtf.common.inject.spi.TypeListener;
 ...
 * com.jd.jtf.common.inject.Provides Provides} bindings can be exposed with the {@literal @}{@link
 * Exposed} annotation:
 *
 * <pre>
...
public abstract class PrivateModule implements Module {
  ...
  /*if[AOP]*/
  /**
   * @see Binder#bindInterceptor(com.jd.jtf.common.inject.matcher.Matcher, com.jd.jtf.common.inject.matcher.Matcher, org.aopalliance.intercept.MethodInterceptor[])
   */
  ...
  /**
   * @see Binder#convertToTypes(com.jd.jtf.common.inject.matcher.Matcher, com.jd.jtf.common.inject.spi.TypeConverter)
   */
  ...
  /**
   * @see Binder#bindListener(com.jd.jtf.common.inject.matcher.Matcher, com.jd.jtf.common.inject.spi.TypeListener)
   */
