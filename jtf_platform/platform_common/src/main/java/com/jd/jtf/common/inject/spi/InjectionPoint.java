...
import static com.jd.jtf.common.inject.internal.MoreTypes.getRawType;

import com.google.common.collect.ImmutableList;
import com.google.common.collect.ImmutableSet;
import com.google.common.collect.Lists;
import com.jd.jtf.common.inject.ConfigurationException;
import com.jd.jtf.common.inject.Inject;
import com.jd.jtf.common.inject.Key;
import com.jd.jtf.common.inject.TypeLiteral;
import com.jd.jtf.common.inject.internal.Annotations;
import com.jd.jtf.common.inject.internal.Errors;
import com.jd.jtf.common.inject.internal.ErrorsException;
import com.jd.jtf.common.inject.internal.Nullability;
...
public final class InjectionPoint {
   ...
   * bindings ({@literal @}{@link com.jd.jtf.common.inject.ImplementedBy ImplementedBy}, default
  ...
  static class InjectableMethod extends InjectableMember {
     ...
     * with com.jd.jtf.common.inject.Inject.  used to allow different
  ...
  static class OverrideIndex {
     ...
     * signature was annotated with a com.jd.jtf.common.inject.Inject.
     * 
     * @param method
      ...
      if (methods != null) {
        for (Iterator<InjectableMethod> iterator = methods.iterator();
          ...
          if (overrides(method, possiblyOverridden.method)) {
            ...
            // remove or if the signature never specified @com.jd.jtf.common.inject.Inject
            // somewhere.
