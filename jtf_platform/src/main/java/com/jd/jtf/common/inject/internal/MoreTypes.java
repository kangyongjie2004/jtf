...
import com.jd.jtf.common.inject.util.Types;
...
public class MoreTypes {
   ...
   * {@code com.jd.jtf.common.inject.Provider} with the same type parameters.
   *
  ...
  public static <T> TypeLiteral<T> canonicalizeForKey(TypeLiteral<T> typeLiteral) {
    ...
    if (typeLiteral.getRawType() == javax.inject.Provider.class) {
      ...
      // the following casts are generally unsafe, but com.jd.jtf.common.inject.Provider extends
