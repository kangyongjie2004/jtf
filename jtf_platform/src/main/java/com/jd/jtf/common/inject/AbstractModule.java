...
public abstract class AbstractModule implements Module {
  ...
  /*if[AOP]*/
  /**
   * @see Binder#bindInterceptor(com.jd.jtf.common.inject.matcher.Matcher,
   *  com.jd.jtf.common.inject.matcher.Matcher,
  ...
  /**
   * @see Binder#bindListener(com.jd.jtf.common.inject.matcher.Matcher,
   *  com.jd.jtf.common.inject.spi.TypeListener)
   * @since 2.0
   */
